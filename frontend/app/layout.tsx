...
export const metadata: Metadata = {
  ...
  description: 'One-stop consulting and tools to run your business like a world-class company. Business audit, growth strategy, automation, and ongoing advisory.',
